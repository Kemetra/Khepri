...
| **R1b** | `Kemetra/Khepri` | **#99, open at the time of writing** — all six checks pass. **This document must merge after it**: the survey link above resolves only once R1b is on `main`. |
...
| **R1b** | Khepri | **Proposed governance drafts.** `docs/platform/proposed-governance/{README, identifier-survey, KHEPRI-DEC-012-amendment, decision-draft-seshat-boundary, family-charter-draft-commercial}.md`. | R1a merged | **#99** — see §0 |
