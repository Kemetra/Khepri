...
D1 product-code authority
  [OWNER-AUTHORED: RRA-014, RCA-006 and RCA-007 each exclude the files D1
   is made of. No D1-02..D1-11 slice may start until it is active.
   D1-01 hands it three decisions -- see §17 item 24]
                 |
                 v
