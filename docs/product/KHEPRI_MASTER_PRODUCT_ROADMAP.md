...
| **W1 Workspace/history** | READY_FOR_IMPLEMENTATION | **Ten of eleven slices are MERGED to `main`**, correcting a row that still read `next actionable task: W1-01` six PRs after `W1-01` landed — the §15 drift this section warns about, and the reason a status claim is verified against merged commits rather than read. `W1-01` `1397b69` (`#368`), `W1-02` `d66fe3d` (`#370`), `W1-03` `9e7989b` (`#371`), `W1-04` `882166d` (`#372`), `W1-04b` `b16165f` (`#375`), `W1-05` `99db705` (`#373`) with `fedb723` (`#374`), `W1-06` `e93356c` (`#376`) with `a894074` (`#378`) and `3867b8a` (`#381`), `W1-08` `267c50c` (`#377`), `W1-07a` `4d79692` (`#382`), `W1-07b` `89796bd` (`#384`), `W1-10` `916d679` (`#385`). **`KHEPRI-DEC-033` §5 is discharged**: `W1-07b` shipped the retention sweep with a caller in the built wheel, so the horizons are enforced rather than intent. **`G3-04` allocated ten slice IDs, not nine**, and carried no `W1-09` at all — the arithmetic in the previous wording was wrong in both directions. **`W1-09` is the one remaining slice**, unblocked 2026-09-06 by active `KHEPRI-DEC-034` (`1d8c5de`, `#386`), which authored the authority it had never had rather than amending `KHEPRI-DEC-015` §3; `RCA-005` gained `FR-128` and `FR-129`. Its bounded plan and RED tests exist (`docs/superpowers/plans/2026-09-06-w1-09-implementation-plan.md`), which is what makes this row `READY_FOR_IMPLEMENTATION` rather than `READY_FOR_PLAN`. Per §15 it does **not** read `MERGED`: that requires a `main` SHA, and `W1-09`'s does not exist while its pull request is open. **`W1-11` repeat-use telemetry stays excluded**, needing the same `KHEPRI-DEC-015` §3 amendment as `R8-08`; `KHEPRI-DEC-034` §2 states explicitly that it is no precedent for either |
