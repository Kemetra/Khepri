...
| R4-05 | Implement one-time authenticated redemption into exactly one membership | R4-03, R2 merged, R3 actor resolution, R1-07, R3-12, issuance-versus-purge resolved (`R4-01` §8.2) | no | Membership creation |
