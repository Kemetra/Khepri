...
LEGAL_DOCUMENTS = {
    "privacy-policy": {
        ...
        "ar": (
            ...
            "ستوضح النسخة العامة موقف نقل البيانات الدولي المنطبق بعد التحقق منه؛ ولا يذكر هذا المسود مكان تشغيل أو إقامة للبيانات.",
    ...
    "data-protection": {
        ...
        "ar": (
            ...
            "يصف البيان العام الضمانات المؤكدة فقط للبيئة التي يصفها. ولا يذكر مكان تشغيل أو موقف إقامة بيانات أو التزامًا بالتعافي أو التزامًا بمستوى الخدمة.",
